        ...
        Expanded(
          ...
          child: TextButton(
            onPressed: () async {
              ...
              ///this was before changed on 17 Nov
              ...
              var maxtime = DateTime.parse(startTimeOriginal).add(Duration(
                  minutes: DateTime.parse(endTimeOriginal)
              ...
              showCupertinoModalPopup(
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: CupertinoDatePicker(
                              ...
                              minuteInterval: 15,
                              initialDateTime:
                                  DateTime.now().roundDown().isAfter(mintime)
                                      ? mintime.add(Duration(hours: 2))
                                      : DateTime.now().roundDown(),
                              minimumDate: mintime,
                              maximumDate: maxtime,
                ...
                if (newTime != null) {
                  customSelectedStartTime = widget.selectedShift
                      .makeTimeStringFromHourMinute(
                          newTime!.hour, newTime!.minute);
                  DateTime tempStart = DateFormat("yyyy-MM-dd HH:mm:ss")
                      .parse(startTimeOriginal);
                  DateTime tempEnd =
                      DateFormat("yyyy-MM-dd HH:mm:ss").parse(endTimeOriginal);
                  var differenceT = tempEnd.difference(tempStart).inMinutes;
                  ...
                  bool? selected = await showDialog(
                      ...
                      builder: (BuildContext context) {
                        return ChangeShiftTime(
                          hours:
                              tempEnd.difference(tempStart).inHours.toString() +
                                  ' ' +
                                  'Hours : ' +
                                  (tempEnd.difference(tempStart).inMinutes % 60)
                                      .toString() +
                                  ' Minutes',
                          ...
                          endTime: newTime!
                              ...
                              .toString()
                              .timeToShow,
                          startTime: newTime.toString().timeToShow,
                        );
                      });
                  ...
                  if (selected == true) {
                    ...
                    if (mounted)
                      setState(() {
                        widget.selectedShift.startTime =
                            customSelectedStartTime;
                        widget.selectedShift.endTime = widget.selectedShift
                            .makeTimeStringFromHourMinuteMahboob(
                                DateTime(
                                  newTime!
                                      .add(Duration(minutes: differenceT))
